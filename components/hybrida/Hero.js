      ...
      <main className="lg:relative">
        ...
        <div className="flex mx-auto w-full max-w-7xl pt-16 pb-1 text-center sm:pb-1 lg:pb-1 lg:text-left">
          <div className="flex-auto px-6  sm:px-8 lg:w-1/2 xl:pr-16">
            <p className="mt-3 mb-1 max-w-md text-lg font-light text-white sm:text-xl md:mt-5 md:max-w-4xl">
              ...
              interactuar con otros artistas y visitantes, y recibir comentarios
        ...
        <div className="flex-auto px-6 pt-10 sm:px-8 lg:w-1/2 xl:pr-16">
          <h3 className="text-2xl tracking-tight text-hybrida-rosalogo sm:text-3xl md:text-4xl lg:text-3xl xl:text-4xl">
            <span className="block xl:inline">¿Qué es Hybrida?</span>
          </h3>
        </div>
        <div className="flex mx-auto w-full max-w-7xl pt-1 pb-1 text-center sm:pb-1 lg:pb-1 lg:text-left">
          <div className="flex-auto px-6  sm:px-8 lg:w-1/2 xl:pr-16">
            ...
            <p className="mt-0 mb-1 max-w-md text-lg font-light text-white sm:text-xl md:mt-5 md:max-w-4xl">
              ...
              espacio para el aprendizaje colectivo y para generar
              conversaciones a partir de las múltiples posibilidades de
              hibridación entre el arte, el diseño y la digitalidad.
            </p>
          </div>
        </div>
        <div className="flex-auto px-6 pt-10 sm:px-8 lg:w-1/2 xl:pr-16">
        ...
        <div className="flex mx-auto w-full max-w-7xl pt-1 pb-1 text-center sm:pb-1 lg:pb-1 lg:text-left">
          <div className="flex-auto px-6  sm:px-8 lg:w-1/2 xl:pr-16">
            <p className="mt-0 mb-1 max-w-md text-lg font-light text-white sm:text-xl md:mt-5 md:max-w-4xl">
              ...
              Realidad Aumentada, programación de software, inteligencia
              artificial, aprendizaje automático, blockchain, modelado y
        ...
        <div className="flex-auto px-6 pt-10 sm:px-8 lg:w-1/2 xl:pr-16">
          <h3 className="text-2xl tracking-tight text-hybrida-rosalogo sm:text-3xl md:text-4xl lg:text-3xl xl:text-4xl">
            <span className="block xl:inline">Fechas importantes</span>
          </h3>
        </div>
        <div className="flex mx-auto w-full max-w-7xl pt-1 pb-1 text-center sm:pb-1 lg:pb-1 lg:text-left">
          <div className="flex-auto px-6  sm:px-8 lg:w-1/2 xl:pr-16">
            <p className="mt-0 mb-1 max-w-md text-lg font-light text-white sm:text-xl md:mt-5 md:max-w-4xl">
              ...
              2023. <br />
              Anuncio de los candidatos seleccionados: X de XXXXX - X de XXXXX
              de 2023. <br />
              Evaluación de productos obtenidos: X de XXXXX - X de XXXXX de
              2023.
              <br />
              Anuncio de ganadores: X de XXXXX - X de XXXXX de 2023.
              <br />
              Evento de lanzamiento: Del X de XXXXX al X de XXXXX de 2023.
            </p>
          </div>
        </div>
        <div className="flex-auto px-6 pt-10 sm:px-8 lg:w-1/2 xl:pr-16">
