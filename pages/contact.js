                    ...
                    <div className="mt-12">
                        ...
                        >
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input
                                        ...
                                        id="phone"
                                        autoComplete="tel"
                                        className="py-3 px-4 block w-full pl-20 focus:ring-pink-500 focus:border-pink-500 border-gray-300 rounded-md"
                            ...
                            <div className="sm:col-span-2">
                                <button
                                    type="submit"
                                    className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-pink-500 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                                >
