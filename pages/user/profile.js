                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <div className="my-4">
                        ...
                        <input
                          ...
                          disabled
                          autoComplete="email"
                          className="text-gray-500 cursor-not-allowed mt-1 bg-gray-100 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm"
                          {...register("email")}
                        />
                      </div>
                    </div>
                        ...
                        <div className="flex items-center">
                          ...
                          >
                            <span>
                              <div
                                type="button"
                                className="pointer-cursor ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                              >
