            ...
            <div className="content flex justify-center items-center w-full my-16">
                <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
                    <div className="rounded-md shadow">
                        <Link href="/artistas/moneditakawaiiunicorn" passHref>
                    ...
                    <div className="rounded-md shadow">
                        <Link href="/artistas/monedalaton" passHref>
                            <div className="thumbitem  cursor-pointer mx-4 mb-4  shadow-md">
                                <div className="photocontainer">
                                    <Image
                    ...
                    <div className="rounded-md shadow">
                        <Link href="/artistas/monedadollar" passHref>
                            <div className="thumbitem  cursor-pointer mx-4 mb-4  shadow-md">
                                <div className="photocontainer">
                                    <Image
                    ...
                    <div className="rounded-md shadow">
                        <Link href="/artistas/monedaolimpiadas" passHref>
                            <div className="thumbitem  cursor-pointer mx-4 mb-4  shadow-md">
                                <div className="photocontainer">
                                    <Image
