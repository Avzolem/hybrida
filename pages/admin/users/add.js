                                ...
                                <div className="formcontainer w-full flex-col items-start justify-center px-8 ">
                                    <div className="wrapper mx-auto">
                                        <div className="inputfield lg:w-1/2 mb-4">
                                            <p className="mb-2">
                                                Los usuarios agregados tienen
                                                que acceder con passwordless
                                                email.
                                            </p>
                                            ...
                                            >
                                                <div className="fields max-w-md">
                                                    ...
                                                    <div className="mt-4">
                                                        <button
                                                            type="submit"
                                                            className="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-happy-pink-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                                                            disabled={isLoading}
                                                        >
